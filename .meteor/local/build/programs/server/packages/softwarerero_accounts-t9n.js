...
de = {                                                                                                                 // 4
  ...
  error: {                                                                                                             // 6
    ...
    signInRequired: "Eine Anmeldung ist erforderlich.",                                                                // 59
    ...
    accounts: {                                                                                                        // 59
      ...
      "Must be logged in": "Eine Anmeldung ist erforderlich",                                                          // 75
...
en = {                                                                                                                 // 3
  ...
  error: {                                                                                                             // 5
    ...
    accounts: {                                                                                                        // 71
      ...
      "undefined": "Something went wrong",                                                                             // 87
...
es = {                                                                                                                 // 4
  ...
  "with": "con",                                                                                                       // 6
  maxAllowedLength: "Longitud máxima permitida",                                                                       // 6
  minRequiredLength: "Longitud máxima requerida",                                                                      // 6
  resendVerificationEmail: "Mandar email de nuevo",                                                                    // 6
  resendVerificationEmailLink_pre: "Email de verificación perdida?",                                                   // 6
  resendVerificationEmailLink_link: "Volver a mandar",                                                                 // 6
  enterPassword: "Introducir contraseña",                                                                              // 6
  enterNewPassword: "Introducir contraseña nueva",                                                                     // 6
  enterEmail: "Introducir email",                                                                                      // 6
  enterUsername: "Introducir nombre de usario",                                                                        // 6
  enterUsernameOrEmail: "Introducir nombre de usario o email",                                                         // 6
  orUse: "O usar",                                                                                                     // 6
  info: {                                                                                                              // 6
    emailSent: "Email enviado",                                                                                        // 59
    emailVerified: "Email verificado",                                                                                 // 59
    passwordChanged: "Contraseña cambiada",                                                                            // 59
  ...
  alert: {                                                                                                             // 6
    ...
    type: {                                                                                                            // 65
      info: 'Aviso',                                                                                                   // 67
      error: 'Error',                                                                                                  // 67
      warning: 'Advertencia'                                                                                           // 67
    }                                                                                                                  //
  },                                                                                                                   //
  error: {                                                                                                             // 6
    emailRequired: "El email es requerido.",                                                                           // 72
    minChar: "7 caracteres mínimo.",                                                                                   // 72
    pwdsDontMatch: "Las contraseñas no coinciden",                                                                     // 72
    pwOneDigit: "mínimo un dígito.",                                                                                   // 72
    pwOneLetter: "mínimo una letra.",                                                                                  // 72
    signInRequired: "Debes iniciar sesión para hacer eso.",                                                            // 72
    signupCodeIncorrect: "El código de suscripción no coincide.",                                                      // 72
    signupCodeRequired: "Se requiere el código de suscripción.",                                                       // 72
    usernameIsEmail: "El usuario no puede ser el email.",                                                              // 72
    usernameRequired: "Se requiere un usuario.",                                                                       // 72
    accounts: {                                                                                                        // 72
      "Email already exists.": "El email ya existe.",                                                                  // 89
      "Email doesn't match the criteria.": "El email no coincide con los criterios.",                                  // 89
      "Invalid login token": "Token de inicio de sesión invalida",                                                     // 89
      "Login forbidden": "Inicio de sesión prohibido",                                                                 // 89
      "Service unknown": "Servicio desconocido",                                                                       // 89
      "Unrecognized options for login request": "Opciones desconocidas para solicitud de inicio de sesión",            // 89
      "User validation failed": "No se ha podido validar el usuario",                                                  // 89
      "Username already exists.": "El usuario ya existe.",                                                             // 89
      "You are not logged in.": "No estas autenticado.",                                                               // 89
      ...
      "Your session has expired. Please log in again.": "Tu sesión ha expirado. Por favor ingresa de nuevo.",          // 89
      "Already verified": "Ya ha sido verificada",                                                                     // 89
      "Invalid email or username": "Email o nombre de usuario no validos",                                             // 89
      "Internal server error": "Error interno del servidor",                                                           // 89
      "undefined": "Algo ha ido mal",                                                                                  // 89
      "No matching login attempt found": "Ningún intento de inicio de sesión coincidente se encuentra",                // 89
      "Password is old. Please reset your password.": "Contraseña es vieja. Por favor resetear la contraseña.",        // 89
      "Incorrect password": "Contraseña inválida. No estas autenticado.",                                              // 89
      "Invalid email": "Email inválida",                                                                               // 89
      "Must be logged in": "Debes ingresar",                                                                           // 89
      "Need to set a username or email": "Tienes que especificar un usuario o un email",                               // 89
      "old password format": "formato viejo de contraseña",                                                            // 89
      "Password may not be empty": "Contraseña no puede quedar vacía",                                                 // 89
      "Signups forbidden": "Registro prohibido",                                                                       // 89
      "Token expired": "Token expirado",                                                                               // 89
      "Token has invalid email address": "Token contiene un email inválido",                                           // 89
      "User has no password set": "Usuario no tiene contraseña",                                                       // 89
      "User not found": "Usuario no encontrado",                                                                       // 89
      "Verify email link expired": "El enlace para verificar el email ha expirado",                                    // 89
      ...
      "Match failed": "Encontrar pareja coincidente ha fallado",                                                       // 89
      "Unknown error": "Error desconocido",                                                                            // 89
...
es_ES = {                                                                                                              // 4
  ...
  enterUsername: "Introducir nombre de usario",                                                                        // 6
  enterUsernameOrEmail: "Introducir nombre de usario o email",                                                         // 6
  orUse: "O puedes usar",                                                                                              // 6
  info: {                                                                                                              // 6
    emailSent: "Email enviado",                                                                                        // 59
    emailVerified: "Email verificado",                                                                                 // 59
    passwordChanged: "Contraseña cambiado",                                                                            // 59
  ...
  error: {                                                                                                             // 6
    ...
    minChar: "7 carácteres mínimo.",                                                                                   // 72
    pwdsDontMatch: "Contraseñas no coninciden",                                                                        // 72
    pwOneDigit: "mínimo un dígito.",                                                                                   // 72
    pwOneLetter: "mínimo una letra.",                                                                                  // 72
    signInRequired: "Debes iniciar sesión para esta opción.",                                                          // 72
    signupCodeIncorrect: "Código de registro inválido.",                                                               // 72
    signupCodeRequired: "Se requiere un código de registro.",                                                          // 72
    usernameIsEmail: "El usuario no puede ser una dirección de correo.",                                               // 72
    usernameRequired: "Se quiere nombre de usuario.",                                                                  // 72
    accounts: {                                                                                                        // 72
      "Email already exists.": "El correo ya existe.",                                                                 // 89
      "Email doesn't match the criteria.": "El correo no coincide.",                                                   // 89
      "Invalid login token": "Token de inicio de sesión invalido",                                                     // 89
      "Login forbidden": "Inicio de sesión prohibido",                                                                 // 89
      "Service unknown": "Servicio desconocido",                                                                       // 89
      "Unrecognized options for login request": "Opciones desconocidas para solicitud de inicio de sesión",            // 89
      "User validation failed": "No se ha podido validar el usuario",                                                  // 89
      "Username already exists.": "El usuario ya existe.",                                                             // 89
      "You are not logged in.": "No estas conectado.",                                                                 // 89
      ...
      "Your session has expired. Please log in again.": "Tu sesión ha expirado. Por favor inicie sesión de nuevo.",    // 89
      "Already verified": "Ya ha sido verificada",                                                                     // 89
      "Invalid email or username": "Email o nombre de usuario no validos",                                             // 89
      "Internal server error": "Error interno del servidor",                                                           // 89
      "undefined": "Algo ha ido mal",                                                                                  // 89
      "No matching login attempt found": "Ningún intento de inicio de sesión coincidente se encuentra",                // 89
      "Password is old. Please reset your password.": "Contraseña es vieja. Por favor, resetea la contraseña.",        // 89
      "Incorrect password": "Contraseña inválida.",                                                                    // 89
      "Invalid email": "Email inválida",                                                                               // 89
      "Must be logged in": "Debes ingresar",                                                                           // 89
      "Need to set a username or email": "Tienes que especificar un usuario o un email",                               // 89
      "old password format": "formato viejo de contraseña",                                                            // 89
      ...
      "Please verify your email first. Check the email and follow the link!": "Por favor compruebe su email primero. Siga el link que le ha sido enviado.",
      "A new email has been sent to you. If the email doesn't show up in your inbox, be sure to check your spam folder.": "Un nuevo correo te ha sido enviado. Si no ves el correo en tu bandeja comprueba tu carpeta de spam.",
      "Match failed": "No ha habido ninguna coincidencia",                                                             // 89
      "Unknown error": "Error desconocido",                                                                            // 89
      "Error, too many requests. Please slow down. You must wait 1 seconds before trying again.": "Error, demasiadas peticiones. Por favor no vaya tan rapido. Tienes que esperar almenos 1 segundo antes de provar otra vez."
    }                                                                                                                  //
  }                                                                                                                    //
...
pl = {                                                                                                                 // 3
  ...
  back: "powrót",                                                                                                      // 5
  cancel: "Anuluj",                                                                                                    // 5
  changePassword: "Zmień hasło",                                                                                       // 5
  choosePassword: "Wybierz hasło",                                                                                     // 5
  clickAgree: "Klikając na Zarejestruj się zgadzasz się z naszą",                                                      // 5
  configure: "Konfiguruj",                                                                                             // 5
  createAccount: "Utwórz konto",                                                                                       // 5
  currentPassword: "Aktualne hasło",                                                                                   // 5
  dontHaveAnAccount: "Nie masz konta?",                                                                                // 5
  email: "E-mail",                                                                                                     // 5
  emailAddress: "Adres e-mail",                                                                                        // 5
  emailResetLink: "Wyślij e-mail z linkiem do zmiany hasła",                                                           // 5
  forgotPassword: "Zapomniałeś hasła?",                                                                                // 5
  ifYouAlreadyHaveAnAccount: "Jeżeli już masz konto",                                                                  // 5
  newPassword: "Nowe hasło",                                                                                           // 5
  newPasswordAgain: "Nowe hasło (powtórz)",                                                                            // 5
  optional: "Nieobowiązkowe",                                                                                          // 5
  OR: "LUB",                                                                                                           // 5
  password: "Hasło",                                                                                                   // 5
  passwordAgain: "Hasło (powtórz)",                                                                                    // 5
  privacyPolicy: "polityką prywatności",                                                                               // 5
  remove: "usuń",                                                                                                      // 5
  resetYourPassword: "Ustaw nowe hasło",                                                                               // 5
  setPassword: "Ustaw hasło",                                                                                          // 5
  sign: "Podpisz",                                                                                                     // 5
  signIn: "Zaloguj się",                                                                                               // 5
  signin: "zaloguj się",                                                                                               // 5
  signOut: "Wyloguj się",                                                                                              // 5
  signUp: "Zarejestruj się",                                                                                           // 5
  signupCode: "Kod rejestracji",                                                                                       // 5
  signUpWithYourEmailAddress: "Zarejestruj się używając adresu e-mail",                                                // 5
  terms: "warunkami korzystania z serwisu",                                                                            // 5
  updateYourPassword: "Zaktualizuj swoje hasło",                                                                       // 5
  username: "Nazwa użytkownika",                                                                                       // 5
  usernameOrEmail: "Nazwa użytkownika lub adres e-mail",                                                               // 5
  "with": "z",                                                                                                         // 5
  maxAllowedLength: "Maksymalna dopuszczalna długość",                                                                 // 5
  minRequiredLength: "Minimalna wymagana długość",                                                                     // 5
  resendVerificationEmail: "Wyślij maila ponownie",                                                                    // 5
  resendVerificationEmailLink_pre: "Zgubiłeś mail weryfikacyjny?",                                                     // 5
  resendVerificationEmailLink_link: "Wyślij ponownie",                                                                 // 5
  enterPassword: "Wprowadź hasło",                                                                                     // 5
  enterNewPassword: "Wprowadź nowe hasło",                                                                             // 5
  enterEmail: "Wprowadź adres e-mail",                                                                                 // 5
  enterUsername: "Wprowadź nazwę użytkownika",                                                                         // 5
  enterUsernameOrEmail: "Wprowadź nazwę użytkownika lub adres e-mail",                                                 // 5
  orUse: "Lub użyj",                                                                                                   // 5
  info: {                                                                                                              // 5
    emailSent: "Adres e-mail wysłany",                                                                                 // 58
    emailVerified: "Adres e-mail zweryfikowany",                                                                       // 58
    passwordChanged: "Hasło zmienione",                                                                                // 58
    passwordReset: "Hasło wyzerowane"                                                                                  // 58
  },                                                                                                                   //
  alert: {                                                                                                             // 5
    ok: 'Ok',                                                                                                          // 64
    type: {                                                                                                            // 64
  ...
  error: {                                                                                                             // 5
    ...
    pwdsDontMatch: "Hasła są różne",                                                                                   // 71
    pwOneDigit: "Hasło musi zawierać przynajmniej jedną cyfrę.",                                                       // 71
    pwOneLetter: "Hasło musi zawierać 1 literę.",                                                                      // 71
    signInRequired: "Musisz być zalogowany, aby to zrobić.",                                                           // 71
    signupCodeIncorrect: "Kod rejestracji jest nieprawidłowy.",                                                        // 71
    signupCodeRequired: "Wymagany jest kod rejestracji.",                                                              // 71
    usernameIsEmail: "Adres e-mail nie może być nazwą użytkownika.",                                                   // 71
    usernameRequired: "Wymagana jest nazwa użytkownika.",                                                              // 71
    accounts: {                                                                                                        // 71
      "Email already exists.": "Adres e-mail już istnieje.",                                                           // 87
      "Email doesn't match the criteria.": "Adres e-mail nie spełnia kryteriów.",                                      // 87
      "Invalid login token": "Błędny token logowania",                                                                 // 87
      "Login forbidden": "Logowanie zabronione",                                                                       // 87
      "Service unknown": "Nieznana usługa",                                                                            // 87
      "Unrecognized options for login request": "Nieznane parametry w żądaniu logowania",                              // 87
      "User validation failed": "Niepoprawna nazwa użytkownika",                                                       // 87
      "Username already exists.": "Nazwa użytkownika już istnieje.",                                                   // 87
      "You are not logged in.": "Nie jesteś zalogowany.",                                                              // 87
      "You've been logged out by the server. Please log in again.": "Zostałeś wylogowane przez serwer. Zaloguj się ponownie.",
      "Your session has expired. Please log in again.": "Twoja sesja wygasła. Zaloguj się ponownie.",                  // 87
      "Already verified": "Już zweryfikowano",                                                                         // 87
      "Invalid email or username": "Niewłaściwy adress e-mail lub nazwa użytkownika",                                  // 87
      "Internal server error": "Błąd wewnętrzny serwera",                                                              // 87
      "undefined": "Ups, coś poszło nie tak",                                                                          // 87
      "No matching login attempt found": "Nie dopasowano danych logowania",                                            // 87
      "Password is old. Please reset your password.": "Hasło jest stare. Proszę wyzerować hasło.",                     // 87
      "Incorrect password": "Niepoprawne hasło",                                                                       // 87
      "Invalid email": "Błędny adres e-mail",                                                                          // 87
      "Must be logged in": "Musisz być zalogowany",                                                                    // 87
      "Need to set a username or email": "Wymagane ustawienie nazwy użytkownika lub adresu e-mail",                    // 87
      "old password format": "stary format hasła",                                                                     // 87
      "Password may not be empty": "Hasło nie może być puste",                                                         // 87
      "Signups forbidden": "Rejestracja zabroniona",                                                                   // 87
      "Token expired": "Token wygasł",                                                                                 // 87
      "Token has invalid email address": "Token ma niewłaściwy adres e-mail",                                          // 87
      "User has no password set": "Użytkownik nie ma ustawionego hasła",                                               // 87
      "User not found": "Nie znaleziono użytkownika",                                                                  // 87
      "Verify email link expired": "Link weryfikacyjny wygasł",                                                        // 87
      "Verify email link is for unknown address": "Link weryfikacyjny jest dla nieznanego adresu",                     // 87
      "At least 1 digit, 1 lowercase and 1 uppercase": "Przynajmniej jedna cyfra, 1 mała i 1 duża litera",             // 87
      ...
      "Match failed": "Błędne dopasowanie",                                                                            // 87
      "Unknown error": "Nieznany błąd",                                                                                // 87
...
pt = {                                                                                                                 // 3
  ...
  back: "Voltar",                                                                                                      // 5
  cancel: "Cancelar",                                                                                                  // 5
  changePassword: "Alterar senha",                                                                                     // 5
  choosePassword: "Escolha uma senha",                                                                                 // 5
  clickAgree: "Ao clicar em Criar Conta, você estará reconhecendo que aceita nossos Termos de Uso",                    // 5
  configure: "Configurar",                                                                                             // 5
  createAccount: "Criar Conta",                                                                                        // 5
  currentPassword: "Senha Atual",                                                                                      // 5
  dontHaveAnAccount: "Não tem conta?",                                                                                 // 5
  email: "E-mail",                                                                                                     // 5
  emailAddress: "Endereço de e-mail",                                                                                  // 5
  emailResetLink: "E-mail com link para gerar Nova Senha",                                                             // 5
  forgotPassword: "Esqueceu sua senha?",                                                                               // 5
  ifYouAlreadyHaveAnAccount: "Se você já tem uma conta",                                                               // 5
  newPassword: "Nova Senha",                                                                                           // 5
  newPasswordAgain: "Nova Senha (novamente)",                                                                          // 5
  optional: "Opcional",                                                                                                // 5
  OR: "OU",                                                                                                            // 5
  password: "Senha",                                                                                                   // 5
  passwordAgain: "Senha (novamente)",                                                                                  // 5
  privacyPolicy: "Política de Privacidade",                                                                            // 5
  remove: "remover",                                                                                                   // 5
  resetYourPassword: "Gerar nova senha",                                                                               // 5
  setPassword: "Cadastrar Senha",                                                                                      // 5
  sign: "Entrar",                                                                                                      // 5
  signIn: "Entrar",                                                                                                    // 5
  signin: "entrar",                                                                                                    // 5
  signOut: "Sair",                                                                                                     // 5
  signUp: "Criar conta",                                                                                               // 5
  signupCode: "Código de Registro",                                                                                    // 5
  signUpWithYourEmailAddress: "Criar conta utilizando seu endereço de e-mail",                                         // 5
  terms: "Termos de Uso",                                                                                              // 5
  updateYourPassword: "Atualizar senha",                                                                               // 5
  username: "Nome de usuário",                                                                                         // 5
  usernameOrEmail: "Usuário ou e-mail",                                                                                // 5
  "with": "com",                                                                                                       // 5
  maxAllowedLength: "Tamanho máximo permitido",                                                                        // 5
  minRequiredLength: "Tamanho Mínimo requerido",                                                                       // 5
  resendVerificationEmail: "Reenviar e-mail de verificação",                                                           // 5
  resendVerificationEmailLink_pre: "Perdeu o e-mail de verificação?",                                                  // 5
  resendVerificationEmailLink_link: "Enviar novamente",                                                                // 5
  enterPassword: "Digite a senha",                                                                                     // 5
  enterNewPassword: "Digite a nova senha",                                                                             // 5
  enterEmail: "Digite o e-mail",                                                                                       // 5
  enterUsername: "Digite o nome de usuário",                                                                           // 5
  enterUsernameOrEmail: "Digite o nome de usuário ou e-mail",                                                          // 5
  orUse: "Ou use",                                                                                                     // 5
  info: {                                                                                                              // 5
    emailSent: "E-mail enviado",                                                                                       // 58
    emailVerified: "E-mail verificado",                                                                                // 58
    passwordChanged: "Senha atualizada",                                                                               // 58
    passwordReset: "Senha alterada"                                                                                    // 58
  },                                                                                                                   //
  alert: {                                                                                                             // 5
    ok: 'Ok',                                                                                                          // 64
    type: {                                                                                                            // 64
  ...
  error: {                                                                                                             // 5
    ...
    pwdsDontMatch: "Senhas não coincidem",                                                                             // 71
    pwOneDigit: "A Senha deve conter pelo menos um dígito.",                                                           // 71
    pwOneLetter: "A Senha deve conter pelo menos uma letra.",                                                          // 71
    signInRequired: "Você precisa estar logado para fazer isso.",                                                      // 71
    signupCodeIncorrect: "Código de acesso incorreto.",                                                                // 71
    signupCodeRequired: "É necessário um código de acesso.",                                                           // 71
    usernameIsEmail: "Nome de usuário não pode ser um endereço de e-mail.",                                            // 71
    usernameRequired: "Nome de usuário é obrigatório.",                                                                // 71
    accounts: {                                                                                                        // 71
      "Email already exists.": "E-mail já existe.",                                                                    // 87
      "Email doesn't match the criteria.": "E-mail inválido.",                                                         // 87
      "Invalid login token": "Token de login inválido",                                                                // 87
      "Login forbidden": "Login não permitido",                                                                        // 87
      "Service unknown": "Serviço desconhecido",                                                                       // 87
      "Unrecognized options for login request": "Opções desconhecidas para solicitação de login",                      // 87
      "User validation failed": "Validação de usuário falhou",                                                         // 87
      "Username already exists.": "Nome de usuário já existe.",                                                        // 87
      "You are not logged in.": "Você não está logado.",                                                               // 87
      ...
      "Your session has expired. Please log in again.": "Sua sessão expirou. Por favor, efetue login novamente.",      // 87
      "Already verified": "Já verificado",                                                                             // 87
      "Invalid email or username": "Nome de usuário ou e-mail inválido",                                               // 87
      "Internal server error": "Erro interno do servidor",                                                             // 87
      "undefined": "Algo não está certo",                                                                              // 87
      "No matching login attempt found": "Não foi encontrada nenhuma tentativa de login que coincida.",                // 87
      "Password is old. Please reset your password.": "Senha expirou. Por favor, cadastre uma nova senha.",            // 87
      "Incorrect password": "Senha incorreta",                                                                         // 87
      "Invalid email": "E-mail inválido",                                                                              // 87
      "Must be logged in": "É necessário efetuar login",                                                               // 87
      "Need to set a username or email": "É necessário configurar um Nome de Usuário ou E-mail",                       // 87
      "old password format": "Formato de senha antigo",                                                                // 87
      "Password may not be empty": "Senha não pode estar em branco",                                                   // 87
      "Signups forbidden": "Não permitido Criar Conta",                                                                // 87
      "Token expired": "Token expirou",                                                                                // 87
      "Token has invalid email address": "Token tem endereço de e-mail inválido",                                      // 87
      "User has no password set": "Usuário não possui senha cadastrada",                                               // 87
      "User not found": "Usuário não encontrado",                                                                      // 87
      "Verify email link expired": "O link de verificação de e-mail expirou",                                          // 87
      "Verify email link is for unknown address": "O link de verificação de e-mail está configurado para um endereço desconhecido",
      "At least 1 digit, 1 lowercase and 1 uppercase": "Pelo menos 1 número, 1 letra minúscula and 1 maiúscula",       // 87
      ...
      "Match failed": "Senhas não coincidem",                                                                          // 87
...
sv = {                                                                                                                 // 4
  ...
  clickAgree: "När du väljer att bli medlem så godkänner du också vår",                                                // 6
  ...
  ifYouAlreadyHaveAnAccount: "Är du redan medlem?",                                                                    // 6
  ...
  signUpWithYourEmailAddress: "Bli medlem med e-postadress",                                                           // 6
